...
const SuperQuality = () => {
  return (
    <section
    id="about-us"
    className="flex justify-between items-end max-lg:flex-col gap-10 w-full max-container">
    ...
    <p className="mt-6 lg:max-w-lg info-text">Our dedication to deatail and excellence ensures your satisfaction</p>
    <div className="mt-11">
